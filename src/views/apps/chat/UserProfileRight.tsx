                ...
                >
                  {store.selectedChat.contact.avatar ? (
                    <MuiAvatar
                      ...
                      alt={store.selectedChat.contact.nickname}
                    />
                  ) : (
                    <CustomAvatar
                      skin='light'
                    ...
                    >
                      {getInitials(store.selectedChat.contact.nickname)}
                    </CustomAvatar>
                  )}
                </Badge>
              </Box>
              <Typography sx={{ mb: 0.75, fontWeight: 600, textAlign: 'center' }}>
                {store.selectedChat.contact.nickname}
              </Typography>
                  ...
                  <List dense sx={{ p: 0 }}>
                    <ListItem sx={{ px: 2 }}>
                      ...
                      <ListItemText
                        ...
                        secondary={`${store.selectedChat.contact.nickname.replace(/\s/g, '_')}@email.com`}
                      />
                    </ListItem>
                    <ListItem sx={{ px: 2 }}>
                      <ListItemIcon sx={{ mr: 3 }}>
